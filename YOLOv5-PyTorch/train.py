        ...
        if yolo.get_rank() == 0:
            ...
            if len(ckpts) > remaining:
                for i in range(len(ckpts) - remaining):
                    try:
                        os.remove(ckpts[i])  # works on both Windows and Linux
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir",
                        default="E:\\YOLO_V5\\YOLOv5-PyTorch\\dataset\\rock_paper_coco_format")  # root directory of the dataset
    ...
    parser.add_argument('--img-sizes', nargs="+", type=int,
                        default=[512, 640])  # range of input images' max_size during training
    ...
    parser.add_argument("--print-freq", type=int, default=50)  # frequency of printing losses during training
